...
var App = function() {
  ...
  return h(
    ...
    h(
      ...
      h(
        'button',
        {onClick: onCuring, className: modelType === 'curing' ? 'active' : ''},
        '\u3046\u3093\u3061\u304B\u30FC\u308A\u3093\u3050',
      ),
    ),
    loading && h('p', null, 'Now Loading ', progress, '%'),
    modelType === 'otohime' &&
      h(
        'div',
