...
var ThreeScene = /** @class */ (function () {
    function ThreeScene(onUpdate) {
        ...
        this.camera = new THREE.PerspectiveCamera(75, 1.7, 0.1, 10);
        this.isVR = false;
        this.start = function (div) {
            var _a = _this, scene = _a.scene, renderer = _a.renderer;
            _this.camera.position.set(0, 1, 2);
            _this.resize();
            ...
            var controls = new OrbitControls(_this.camera, renderer.domElement);
    ...
    ThreeScene.prototype.switchVR = function () {
        this.isVR = !this.isVR;
        if (this.isVR) {
